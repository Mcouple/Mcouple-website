function onDocumentMouseMove(A) {
    mouseX = .25 * (A.clientX - windowHalfX), mouseY = .15 * (A.clientY - windowHalfY)
}
...
App = {
    init: function() {
        ...
        n.href = window.atob("bWFpbHRvOnN1cGx6eUBnbWFpbC5jb20=")
    }
...
App.init(), console.clear(), animate();